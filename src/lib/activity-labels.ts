...
const LABELS: Record<string, string> = {
  ...
  questionnaire_started: 'Client started project details',
  questionnaire_completed: 'Client completed project details',
  approval_completed: 'Client approved the work',
